function renderLevelOneBlock(container) {
    ...
    function arrayRandElement(newCards) {
        ...
        let randCard = newCards[rand];
        console.log(randCard);
        let imgOne = document.createElement('img');
        let imgTwo = document.createElement('img');
        imgOne.src = randCard.img;
        imgOne.classList.add('cardBox__img');
        imgTwo.src = randCard.img;
        ...
        const clickOne = () => {
            ...
            imgOne.src = randCard.img;
            window.application.cardIdOne.id = randCard.id;
        ...
        const clickTwo = () => {
            clearInterval(cardInterval);
            imgTwo.src = randCard.img;
            window.application.cardIdTwo.id = randCard.id;
